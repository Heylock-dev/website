        ...
        <div className="w-screen h-screen flex flex-row">
            <div className="flex items-center justify-start pl-16  w-1/2 h-full">
                <form className="flex flex-col w-[28rem]">
                    ...
                    <h1 className="text-3xl font-medium mt-4">Create an account</h1>
                    ...
                    <p className="text-deemphasized-text mt-8">Already have an account? <Link href="/sign-in" className="underline underline-offset-2 hover:text-black transition-colors duration-100">Sign in</Link></p>
                </form>
            </div>
            <div
