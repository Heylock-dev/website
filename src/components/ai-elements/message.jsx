...
export const MessageContent = ({
  ...
  <div
    className={cn(
      "flex flex-col gap-2 overflow-hidden text-sm min-w-0",
      "group-[.is-user]:ml-auto group-[.is-user]:rounded-lg group-[.is-user]:bg-secondary group-[.is-user]:px-4 group-[.is-user]:py-3 group-[.is-user]:text-foreground group-[.is-user]:w-fit",
      "group-[.is-assistant]:text-foreground group-[.is-assistant]:w-fit group-[.is-assistant]:max-w-full",
      "[&_table]:w-full",
      className
    )}
    {...props}>
